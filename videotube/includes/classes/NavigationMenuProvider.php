...
class NavigationMenuProvider {
    ...
    public function create() {
        ...
        $menuHtml .= $this->createNavItem("Subscriptions", "assets/images/subscriptions.png", "subscriptions.php");
        $menuHtml .= $this->createNavItem("Liked Videos", "assets/images/thumb-up.png", "likedVideos.php");
